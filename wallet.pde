public class Wallet extends Widget{
  ...
  //Attributs
  String tabChar[] = {"HESTAR Joe","GUETTA David","POINDACIER Sett","HAIS Karim","LINN Maeve","BRIDOU Justin","DEPECAN Benoît","LADE Vanessa","WATSON Emma"};
  String tabApp[] = {"A besoin de s'investir plus","Eleve investit","Eleve turbulent","A besoin d'un accompagnement personnel","Est autonome",
"Eleve un peu perturbateur","A du mal dans les matières scientifiques","Fait des efforts pour améliorer ses résultats","A des résultats excellent"};
  ...
  PImage tabPdp[] = {loadImage("Data/joe.jpg"),loadImage("Data/david.jpg"),loadImage("Data/sett.png"),loadImage("Data/karim.jpg"),loadImage("Data/OIP.jpg"),loadImage("Data/justin.jpg"),
